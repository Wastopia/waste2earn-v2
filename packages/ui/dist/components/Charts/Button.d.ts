...
export type ChartToggleProps = Override<BoxProps, {
    setActiveChartView: (view: ChartView) => void;
    activeView: ChartView;
    chartViews: ChartViewButton[];
}>;
export declare function ChartToggle({ setActiveChartView, activeView, chartViews, ...rest }: ChartToggleProps): JSX.Element;
