...
describe("Position", () => {
    ...
    describe("#amount0", () => {
        it("is correct for price above", () => {
            expect(new Position({
                ...
                tickUpper: nearestUsableTick(POOL_TICK_CURRENT, TICK_SPACING) +
                    TICK_SPACING * 2,
    ...
    describe("#mintAmountsWithSlippage", () => {
        ...
        describe("5% slippage tolerance", () => {
            ...
            it("is correct for pool at max price", () => {
                const position = new Position({
                    pool: new Pool("xxxxxxxxx", DAI, USDC, FeeAmount.LOW, JSBI.subtract(TickMath.MAX_SQRT_RATIO, JSBI.BigInt(1)), 0, TickMath.MAX_TICK - 1, []),
                    liquidity: 100e18,
                    tickLower: nearestUsableTick(POOL_TICK_CURRENT, TICK_SPACING) + TICK_SPACING,
                    tickUpper: nearestUsableTick(POOL_TICK_CURRENT, TICK_SPACING) +
                        TICK_SPACING * 2,
    ...
    describe("#burnAmountsWithSlippage", () => {
        ...
        describe("5% slippage tolerance", () => {
            ...
            it("is correct for pool at max price", () => {
                const position = new Position({
                    pool: new Pool("xxxxxxxxxx", DAI, USDC, FeeAmount.LOW, JSBI.subtract(TickMath.MAX_SQRT_RATIO, JSBI.BigInt(1)), 0, TickMath.MAX_TICK - 1, []),
                    liquidity: 100e18,
                    tickLower: nearestUsableTick(POOL_TICK_CURRENT, TICK_SPACING) + TICK_SPACING,
                    tickUpper: nearestUsableTick(POOL_TICK_CURRENT, TICK_SPACING) +
                        TICK_SPACING * 2,
