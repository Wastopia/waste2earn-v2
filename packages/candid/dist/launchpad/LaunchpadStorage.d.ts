...
export interface _SERVICE {
    ...
    'addTransaction': (arg_0: string, arg_1: HistoryTransaction) => Promise<undefined>;
    'cycleAvailable': () => Promise<NatResult>;
    'cycleBalance': () => Promise<NatResult>;
    'getHistoryTransactionsByPage': (arg_0: string, arg_1: bigint, arg_2: bigint) => Promise<ResponseResult_1>;
    'getSettledLaunchpadsByPage': (arg_0: bigint, arg_1: bigint) => Promise<ResponseResult>;
}
//# sourceMappingURL=LaunchpadStorage.d.ts.map