...
export interface LaunchpadCanister {
    ...
    'computeFinalTokenViewSet': (arg_0: bigint, arg_1: bigint) => Promise<TokenViewSet>;
    ...
    'install': (arg_0: Property, arg_1: string, arg_2: Array<string>) => Promise<BoolResult>;
    'transferByAddress': (arg_0: Principal, arg_1: Principal, arg_2: bigint, arg_3: string, arg_4: string) => Promise<boolean>;
...
export interface LaunchpadManager {
    ...
    'getTicketPackage': (arg_0: string, arg_1: string) => Promise<ResponseResult_4>;
    ...
    'install': (arg_0: Principal, arg_1: Property, arg_2: Array<string>) => Promise<ResponseResult_1>;
...
export type ResponseResult_2 = {
    'ok': Page;
} | {
    'err': string;
};
export type ResponseResult_3 = {
    'ok': string;
} | {
    'err': string;
};
export type ResponseResult_4 = {
    'ok': TicketPackage;
} | {
    'err': string;
};
export type ResponseResult_5 = {
    'ok': bigint;
} | {
    'err': string;
};
export type ResponseResult_6 = {
    'ok': Investor;
} | {
    'err': string;
};
export type ResponseResult_7 = {
    'ok': Array<CanisterView>;
} | {
    'err': string;
};
...
//# sourceMappingURL=LaunchpadManager.d.ts.map