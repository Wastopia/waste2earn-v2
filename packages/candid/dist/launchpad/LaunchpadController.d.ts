...
export interface _SERVICE {
    ...
    'getAllPools': (arg_0: string, arg_1: bigint, arg_2: bigint) => Promise<ResponseResult_1>;
    'getCanisters': () => Promise<ResponseResult_2>;
    'getPoolsByOwner': (arg_0: string, arg_1: bigint, arg_2: bigint) => Promise<ResponseResult_1>;
    'getWhitelist': () => Promise<Array<string>>;
    'install': (arg_0: string, arg_1: Property, arg_2: Array<string>) => Promise<ResponseResult>;
    'result': () => Promise<string>;
    'setController': (arg_0: string, arg_1: string) => Promise<boolean>;
    'uninstall': () => Promise<BoolResult>;
}
//# sourceMappingURL=LaunchpadController.d.ts.map