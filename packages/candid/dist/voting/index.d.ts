...
export type { _SERVICE as VoteFile, Chunk as VotingFileChunk, } from "./FileCanister";
export { idlFactory as VoteProjectInterfaceFactory } from "./VoteProjectCanister.did";
export type { _SERVICE as VoteProject, ProposalInfo, UserVoteRecord, UserVotePowersInfo, ProposalCreateInfo, } from "./VoteProjectCanister";
