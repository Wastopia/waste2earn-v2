...
export default interface _SERVICE {
    ...
    'custom_upgrade_root_bucket': (arg_0: Principal, arg_1: [] | [Array<number>]) => Promise<string>;
    'deploy_plug_bucket': (arg_0: Principal, arg_1: bigint) => Promise<undefined>;
    'get_index_canisters': (arg_0: WithWitnessArg) => Promise<GetIndexCanistersResponse>;
    'get_token_contract_root_bucket': (arg_0: GetTokenContractRootBucketArg) => Promise<GetTokenContractRootBucketResponse>;
    'get_user_root_buckets': (arg_0: GetUserRootBucketsArg) => Promise<GetUserRootBucketsResponse>;
    'git_commit_hash': () => Promise<string>;
    'insert_new_users': (arg_0: Principal, arg_1: Array<Principal>) => Promise<undefined>;
...
//# sourceMappingURL=cap_router.d.ts.map