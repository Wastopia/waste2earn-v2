...
export type Result_1 = { ok: BlockHeight__1 } | { err: CommonError };
export type Result_10 = { ok: bigint } | { err: CommonError__1 };
export type Result_2 = { ok: Page_1 } | { err: CommonError };
export type Result_3 = { ok: bigint } | { err: CommonError };
export type Result_4 = { ok: Balance__1 } | { err: CommonError__1 };
export type Result_5 = { ok: boolean } | { err: CommonError__1 };
export type Result_6 = { ok: boolean } | { err: CommonError };
export type Result_7 = { ok: Metadata } | { err: CommonError__1 };
export type Result_8 = { ok: string } | { err: CommonError__1 };
export type Result_9 = { ok: Page_2 } | { err: CommonError };
