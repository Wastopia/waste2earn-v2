...
export declare const analyticICP: () => Promise<import("@dfinity/agent").ActorSubclass<V2ICPPrice>>;
export declare const analyticTVL: () => Promise<import("@dfinity/agent").ActorSubclass<V2TVL>>;
